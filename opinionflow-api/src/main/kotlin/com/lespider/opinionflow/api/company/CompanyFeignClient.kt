...
/**
 * 中国企业财报服务 Feign 客户端
 * AI 服务（中国企业专家 Agent）通过此接口调用 opinionflow-company 服务查询财务报表数据
 * 对应服务：opinionflow-company（端口 9206，base /api/company）
 * 数据源：company_china 库
 */
@FeignClient(name = "opinionflow-company", path = "/api/company")
